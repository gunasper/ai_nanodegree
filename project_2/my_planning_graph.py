...
class ActionLayer(BaseActionLayer):
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        """
        #I've tried both solutions. They have same results.
        #preconditions_a = actionA.preconditions
        #preconditions_b = actionB.preconditions       
        preconditions_a = self.parents[actionA]
        preconditions_b = self.parents[actionB]

        return any([self.parent_layer.is_mutex(pre_a, pre_b) for pre_a in preconditions_a for pre_b in preconditions_b])
